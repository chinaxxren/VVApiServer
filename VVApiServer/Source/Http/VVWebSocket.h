...
- (id)initWithRequest:(VVHTTPMessage *)request socket:(GCDAsyncSocket *)socket;
...
- (void)webSocket:(VVWebSocket *)ws didReceiveMessage:(NSString *)msg;

- (void)webSocketDidClose:(VVWebSocket *)ws;
